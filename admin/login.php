...
<body>
                    ...
                    <div class="card-body p-4 p-sm-5">
                        ...
                        <form method="post">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control rounded-pill" name="user" id="floatingInput" placeholder="ex: Bahrulanwar" autocomplete="off" required>
                                <label for="floatingInput">Username</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="password" class="form-control rounded-pill" name="pass" id="floatingPassword" placeholder="Password" autocomplete="off" required>
  ...
  <footer class="bg-dark text-white p-5">
    ...
    <div class="copyright text-center text-white font-weight-bold bg-dark p-2">
        <p>Bahrul Anwar Copyright &copy; 2022</p>
    </div>
